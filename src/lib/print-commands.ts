...
function commandAvailableInContext(command): boolean {
  ...
  let availableCommands = ['add-component', 'add-container', 'add-screen', 'add-service', 'create-controller-codebehind-function', 'create-controller-connection-to-store', 'version']
